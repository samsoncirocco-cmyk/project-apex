...
Also, use the latest and most capable models available for complex reasoning and planning tasks. If you're unsure which model to use, default to the most recent release.
